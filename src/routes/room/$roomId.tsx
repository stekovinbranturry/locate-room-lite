...
function RoomPage() {
  ...
  return (
    <div className="relative h-[calc(100dvh-4.5rem)] min-h-[480px] w-full overflow-hidden sm:h-[calc(100dvh-5rem)]">
      <MapView />
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col justify-between p-3 sm:p-4">
        <div className="pointer-events-auto flex flex-wrap items-start gap-2">
          <div className="island-shell rounded-2xl px-4 py-3 shadow-lg">
          ...
          <Link
            to="/"
            className="rounded-full border border-[var(--chip-line)] bg-[var(--surface-strong)] px-4 py-2.5 text-sm font-semibold text-[var(--sea-ink)] no-underline shadow-lg"
          >
            离开
          </Link>
        </div>
        ...
        <div className="pointer-events-auto flex flex-col gap-2 sm:flex-row sm:items-end">
          <aside className="island-shell max-h-40 w-full overflow-auto rounded-2xl p-3 shadow-lg sm:max-w-xs">
